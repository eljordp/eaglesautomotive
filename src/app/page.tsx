...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-svh flex items-center justify-center overflow-hidden noise">
        {/* Background image */}
        <div
        ...
        {/* Accent glow */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-red/[0.07] rounded-full blur-[120px] sm:blur-[150px]" />

        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 text-center pt-24 pb-32 sm:py-0">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm rounded-full px-4 py-1.5 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] sm:tracking-[0.25em] text-white/40 font-medium mb-8 sm:mb-10">
            <span className="w-1.5 h-1.5 bg-red rounded-full" />
            Murfreesboro&apos;s Trusted Dealer
          </div>

          <h1 className="text-[44px] sm:text-7xl lg:text-[110px] font-black tracking-[-0.03em] mb-5 sm:mb-6 leading-[0.85]">
          ...
          <p className="text-sm sm:text-lg text-white/40 max-w-md sm:max-w-xl mx-auto mb-8 sm:mb-12 leading-relaxed font-light px-2">
            Premium pre-owned vehicles, transparent pricing, and financing built around you.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-2">
            <Link
              href="/inventory"
              className="w-full sm:w-auto bg-red hover:bg-red-hover text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-sm font-semibold text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-[0_0_40px_rgba(91,141,184,0.3)] text-center"
            >
              Explore Inventory
            </Link>
            <Link
              href="/financing"
              className="w-full sm:w-auto border border-white/[0.12] hover:border-white/30 text-white/70 hover:text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-sm font-semibold text-sm uppercase tracking-wider transition-all duration-300 text-center"
            >
              Get Pre-Approved
            </Link>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center sm:justify-between py-5 sm:py-8 border-t border-white/[0.06]">
              <div className="flex items-center gap-6 sm:gap-16">
                {[
                  ...
                  <div key={stat.label} className="text-center sm:text-left">
                    ...
                    <div className="text-[9px] sm:text-[11px] text-white/30 uppercase tracking-[0.15em] font-medium">{stat.label}</div>
                  </div>
                ))}
              </div>
              <a
      ...
      <section className="relative py-16 sm:py-28">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8 sm:mb-14">
            <div>
              <div className="text-[11px] uppercase tracking-[0.3em] text-red font-semibold mb-2 sm:mb-3">Curated Selection</div>
              <h2 className="text-2xl sm:text-5xl font-black tracking-tight">Featured Vehicles</h2>
            </div>
            <Link
              href="/inventory"
      ...
      <section className="relative py-16 sm:py-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            {/* Left — text */}
            <div>
              <div className="text-[11px] uppercase tracking-[0.3em] text-red font-semibold mb-2 sm:mb-3">Why Eagles</div>
              <h2 className="text-2xl sm:text-5xl font-black tracking-tight mb-5 sm:mb-6 leading-[1.1]">
                Not Just a Dealership.<br />
                <span className="text-white/40">A Different Experience.</span>
              </h2>
              <p className="text-sm sm:text-base text-white/40 leading-relaxed mb-8 sm:mb-10 max-w-md">
              ...
              <div className="space-y-5 sm:space-y-6">
                {[
                  ...
                  <div key={item.num} className="flex gap-4 sm:gap-5 group">
                    <div className="text-[11px] font-bold text-red/40 pt-0.5 tabular-nums">{item.num}</div>
                    <div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] sm:aspect-[4/5] rounded-sm overflow-hidden">
                <img
              ...
              {/* Floating stat card */}
              <div className="absolute bottom-4 left-4 sm:bottom-8 sm:-left-8 glass border border-white/[0.06] rounded-sm px-5 sm:px-8 py-4 sm:py-6">
                <div className="flex items-center gap-2 mb-1">
                  <div className="flex gap-0.5">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <svg key={i} className="w-3 sm:w-3.5 h-3 sm:h-3.5 text-gold" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="text-[10px] sm:text-[11px] text-white/40 tracking-wide">53+ Reviews on Google</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-28">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <div className="text-[11px] uppercase tracking-[0.3em] text-red font-semibold mb-2 sm:mb-3">Testimonials</div>
            <h2 className="text-2xl sm:text-5xl font-black tracking-tight">Straight From Our Customers</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={i}
                className="relative bg-card border border-white/[0.04] rounded-sm p-6 sm:p-8 hover:border-white/[0.08] transition-all duration-500"
              >
                <div className="text-5xl sm:text-6xl font-serif text-red/10 leading-none mb-3 sm:mb-4">&ldquo;</div>
                <p className="text-white/50 text-sm leading-relaxed mb-5 sm:mb-6">{review.text}</p>
      ...
      <section className="relative py-20 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-5xl lg:text-6xl font-black tracking-tight mb-5 sm:mb-6 leading-[0.95]">
            Ready to Drive<br />
            <span className="text-red">Something Better?</span>
          </h2>
          <p className="text-sm sm:text-base text-white/40 mb-8 sm:mb-10 max-w-lg mx-auto leading-relaxed">
